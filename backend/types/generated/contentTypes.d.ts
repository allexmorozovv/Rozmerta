...
export interface ApiDishCardDishCard extends Struct.CollectionTypeSchema {
  collectionName: 'dish_cards';
  info: {
    singularName: 'dish-card';
    pluralName: 'dish-cards';
    displayName: 'Dish-card';
    description: '';
  };
  options: {
...
export interface ApiHeroPhotoHeroPhoto extends Struct.CollectionTypeSchema {
  collectionName: 'hero_photos';
  info: {
    singularName: 'hero-photo';
    pluralName: 'hero-photos';
    displayName: 'Hero-photos';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Component<'menu.m-link', true>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::dish-card.dish-card': ApiDishCardDishCard;
      'api::global.global': ApiGlobalGlobal;
      'api::hero-photo.hero-photo': ApiHeroPhotoHeroPhoto;
